...
function Thumbnail({ data }: { data: Post }) {
  return (
    <div className="relative ml-2.5 h-full w-[75px] rounded border border-neutral-300 sm:w-[200px]">
...
export default function Card({ data }: { data: Post }) {
  return (
    <div className="group relative mx-auto flex w-full max-w-lg flex-row items-center justify-between border-b border-neutral-700 py-4 text-white last-of-type:border-b-0 hover:cursor-pointer hover:bg-neutral-700/50 sm:pl-5 sm:pr-14 md:px-2 lg:py-10">
      <Content data={data} />
      <Thumbnail data={data} />
    </div>
  );
